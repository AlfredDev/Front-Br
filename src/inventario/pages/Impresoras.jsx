...
import { ImpresoraForm } from '../forms/ImpresoraForm';
...
export const Impresoras = () => {
    ...
    return (
        <div className='flex flex-col h-screen p-7' >
            ...
            <BotonesBottom label={'Agregar Impresora'} addHandle={onOpenhandled} />

            {showModal
                ?
                <Modal setShowModal={setShowModal} body={<ImpresoraForm />} />
                : null
            }
        </div>
    )
